...
namespace Zero.Ecs
{
    ...
    {
        private EntityArchetype _any = new EntityArchetype(new ulong[1]);
        private EntityArchetype _no = new EntityArchetype(new ulong[1] { TypeCache.DisabledArchetypeMask });
        private EntityArchetype _with = new EntityArchetype(new ulong[1]);
